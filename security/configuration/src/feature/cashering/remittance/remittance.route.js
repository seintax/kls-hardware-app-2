...
const service = require('./remittance.query')

router.route('/cashering/remittance')
    .get(async (req, res) => {
...
router.get('/cashering/remittance/element', async (req, res) => {
...
router.get('/cashering/remittance/search', async (req, res) => {
