...
const selectRecord = async (param, callback) => {
    ...
    //     return callback(null, ans)
    // })
    let sql = query.optimize.rec(table.transfer, options.filter, options.order)
...
const uniqueRecord = async (param, callback) => {
    ...
    //     return callback(null, ans)
    // })
    let sql = query.optimize.get(table.transfer, table.transfer.fields.id)
...
const searchRecord = async (param, callback) => {
    ...
    //     return callback(null, ans)
    // })
    let sql = query.optimize.src(table.transfer, helper.filters, [date?.Desc()])
