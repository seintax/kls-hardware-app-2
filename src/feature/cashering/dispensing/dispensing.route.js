...
router.route('/cashering/dispensing')
    .get(async (req, res) => {
...
router.get('/cashering/dispensing/element', async (req, res) => {
...
router.get('/cashering/dispensing/search', async (req, res) => {
...
router.post('/cashering/dispensing/batch', async (req, res) => {
