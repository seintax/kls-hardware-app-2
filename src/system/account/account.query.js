...
const selectRecord = async (param, callback) => {
    ...
    //     return callback(null, ans)
    // })
    let sql = query.optimize.rec(table.account, options.filter, options.order)
...
const uniqueRecord = async (param, callback) => {
    ...
    //     return callback(null, ans)
    // })
    let sql = query.optimize.get(table.account, table.account.fields.id)
...
const searchRecord = async (param, callback) => {
    ...
    //     return callback(null, ans)
    // })
    let sql = query.optimize.src(table.account, helper.filters, [id?.Asc()])
