...
import { fetchCreditsBySettled } from "./credits.services"
...
const CreditsPaid = () => {
    ...
    const { data, isLoading, isError, refetch } = useQuery('credits-item-paid', () => fetchCreditsBySettled(id, search.key))
    ...
    const columns = {
        ...
        items: [
            ...
            { name: 'Payment', stack: true, sort: 'payment', size: 150 },
    ...
    const items = (item) => {
        return [
            ...
            { value: currencyFormat.format(item.payment) },
